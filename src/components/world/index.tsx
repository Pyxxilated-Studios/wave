...
class World extends React.Component<WorldProps> {
    ...
    componentDidUpdate(prevProps: WorldProps, prevState: any) {
...
const mapDispatchToProps = (dispatch: any): DispatchProps => {
    const actions = {
        takeMonstersTurn: () => dispatch(takeMonstersTurn()),
        loadMonsters: () => dispatch(loadMonsters()),
        exploreTiles: (position: Point) => dispatch(exploreTiles(position)),
    };
    return actions;
};
